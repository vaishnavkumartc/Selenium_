...
public interface WdMethods {
		...
		/**
		 * This method will write pass step to the extent report
		 * @author vaishnav - TestLeaf
		 * @throws IOException 
		 */
		void extentPass(String TestName, String Testdesc, String stepdesc) throws IOException;
